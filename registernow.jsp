...
<b>Blood group :</b>
  ...
  <br><br>
<label for="text"><b>Symptoms :</b></label><br>
    <input type="text" placeholder="Enter your Symptoms" name="Symptoms"required>
	<br><br>
<label for="text"><b>Previous medical history :</b></label><br>
    <input type="text" placeholder="Enter your medical history" name="history"required>
	<br><br>
